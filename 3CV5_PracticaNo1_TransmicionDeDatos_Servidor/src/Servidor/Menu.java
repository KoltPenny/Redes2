...
public class Menu extends javax.swing.JFrame {
    ...
    public void setDataTable(Object [] b){
        this.defaultModel.addRow(b);
    }
    
    public void setBar(int p){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Progreso de envio:");
    ...
    private void btnBufferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBufferActionPerformed
        ...
        s.setSizeBuffer(Integer.parseInt(txtBuffer.getText()));
        server = s;
        System.out.println("Buufer server: " + server.getSizeBuffer());
        JOptionPane.showMessageDialog(null,"El buffer ahora es de: " + txtBuffer.getText());
        server.start();
        ArrayList<Object> obj = server.getFiles();
        for(int i = 0 ; i < obj.size(); i++)
            defaultModel.addRow((Object[]) obj.get(i));
